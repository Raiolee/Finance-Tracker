    ...
    <div class="modal-content">
        ...
        <form class="form-container" id="SavingForm" method="post" action="">
            <div class="big-divider full">
                ...
                <input class="var-input" type="text" name="bank-name" value="Name" required>
                <label for="Bank" class="form-labels">Bank</label>
                <input class="var-input" type="text" id="bank" name="bank" value="Bank Name" required>
                <label class="form-labels" for="amount">Amount</label>
                <input class="var-input" type="number" id="bank-amount" name="bank-amount" value="0.00" required>
